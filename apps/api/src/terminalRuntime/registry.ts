...
const parseV3Terminals = (
  ...
  for (const item of rawTerminals) {
    ...
    if (typeof entry.characterId === "string") terminal.characterId = entry.characterId;
    if (typeof entry.customAvatarPath === "string") {
      terminal.customAvatarPath = entry.customAvatarPath;
    }
